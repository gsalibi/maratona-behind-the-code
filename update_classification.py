...
urls = ["https://maratona.dev/pt/ranking?c=1", "https://maratona.dev/pt/ranking?c=2", 
        ...
        "https://maratona.dev/pt/ranking?c=7", "https://maratona.dev/pt/ranking?c=8"]
challenges = [dict(), dict(), dict(), dict(), dict(), dict(), dict(), dict()]
...
with file:     
    ...
    write.writerow(['Participante','Pontos Σ(101 - posição_desafio)', 'Desafio 1', 'Desafio 2', 'Desafio 3', 'Desafio 4', 'Desafio 5', 'Desafio 6', 'Desafio 7', 'Desafio 8'])
